...
describe('lib/index --- ', () => {
  ...
  test('test print empty string with undefined config', () => {
  ...
  test('test print empty string with empty config', () => {
    expect(consoleSpy).not.toHaveBeenCalled();
    source.PRINT({});
    expect(consoleSpy).toHaveBeenCalled();
    expect(consoleSpy).toHaveBeenCalledTimes(3);
  ...
  test('test print TEST_DATA_EXP with config', () => {
    expect(consoleSpy).not.toHaveBeenCalled();
  ...
  test('test print TEST_DATA_EXP with config as banner', () => {
    expect(consoleSpy).not.toHaveBeenCalled();
  ...
  test('test print TEST_DATA_EXP with config as banner, font as slant', () => {
    expect(consoleSpy).not.toHaveBeenCalled();
  ...
  test('test print TEST_DATA_EXP with config as banner, color as red', () => {
    expect(consoleSpy).not.toHaveBeenCalled();
  ...
  test('test print TEST_DATA_EXP with config as banner, background color is cyan', () => {
    expect(consoleSpy).not.toHaveBeenCalled();
