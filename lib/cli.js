...
commander.version(require('./../package.json').version, '    --version')
    ...
    .option('-f  --font [font]', 'font used to print text [' + source.options.availableFonts.join('|') + ']')
    .option('-c  --color [color]', 'color of the printed text [' + source.options.availableColors.join('|') + ']')
    .option('    --bg-color [bg color]', 'background color of the printed text [' + source.options.availableBgColors.join('|') + ']');
